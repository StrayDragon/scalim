...
- **YAML vs Python 边界**（灰区 / 已迁出 / 勿混 cache_mode）: 读 [references/yaml-runtime-policy-boundary.md](references/yaml-runtime-policy-boundary.md)（调研: `llmanspec/changes/c40-yaml-runtime-policy-boundary/inventory.md`）
