...
- **YAML vs Python 边界**（开放盘点；动态 knobs 目标收口 Python）: 读 [references/yaml-runtime-policy-boundary.md](references/yaml-runtime-policy-boundary.md)（`llmanspec/changes/c40-yaml-runtime-policy-boundary/inventory.md`）
