...
- `src/IMPL_ROOT/dsl/yaml_dsl/workflow_entrypoints.py` (preflight 插入点)
- `src/IMPL_ROOT/dsl/yaml_dsl/workflow_preflight.py` (preflight 框架 + v1 check)
- `src/IMPL_ROOT/dsl/yaml_dsl/runtime/compiler.py` (YAML 层抢跑防护: overrides 存在时禁用 YAML precheck)
## Requirements
