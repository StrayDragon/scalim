...
- `notebooks/marimo/demo_big_data_report/chapters/*.py` (每章 notebook; 薄封装)
- `packages/scalim-misc/src/scalim_misc/demo_big_data_report/chapters/registry.py` (章节 registry + runner 复用入口)
