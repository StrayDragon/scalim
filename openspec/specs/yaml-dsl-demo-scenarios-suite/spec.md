...
系统 MUST 在 `notebooks/marimo/demo_big_data_report/chapters_of_yaml_dsl/declared_yaml_dsl/` 下维护一个 YAML DSL 场景库（fixtures），第一版至少包含：
...
- **WHEN** 维护者检查 `notebooks/marimo/demo_big_data_report/chapters_of_yaml_dsl/declared_yaml_dsl/ads/` 与 `notebooks/marimo/demo_big_data_report/chapters_of_yaml_dsl/declared_yaml_dsl/support/`
