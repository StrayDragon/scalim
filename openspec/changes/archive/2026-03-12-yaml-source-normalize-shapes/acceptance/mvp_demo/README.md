...
```bash
uv run python openspec/changes/yaml-source-normalize-shapes/acceptance/mvp_demo/run_demo.py
# 或(不依赖安装环境):
PYTHONPATH=src python openspec/changes/yaml-source-normalize-shapes/acceptance/mvp_demo/run_demo.py
```
