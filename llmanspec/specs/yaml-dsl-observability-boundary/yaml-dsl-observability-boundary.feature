...
# purpose: 将 observability 配置从 YAML 主线移除，迁移到 Python/CLI runtime entrypoints，并在迁移期内提供可执行的迁移警告。 [rev:c25]
# scope: src/scalim/
功能: yaml-dsl-observability-boundary
  ...
  @req:r565 @human
  场景: docs, skills, notebooks and examples MUST migrate away from YAML observability fields
