...
# purpose: 定义 workflow runtime 的质量与测试稳定性要求,包括依赖注入契约、规则 SSOT 复用与并发测试的确定性护栏. [rev:c25]
# scope: src/scalim/
功能: workflow-runtime-quality-and-test-stability

  @req:r96 @human
  场景: workflow entrypoints MUST support dependency injection without module-global ation
