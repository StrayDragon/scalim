...
- [ ] `design.md`（可选）
- [ ] `tasks.md` + delta specs（或新工具链等价物）
- [ ] `llman sdd validate c0-remove-book-budget-policy --strict`
- [ ] upgrade：`agentdev/skills/scalim-yaml-dsl/references/upgrades/YYYY-MM-DD-remove-book-budget-policy.md`
