...
def _build_engine_row(rows, n_derived):
...
def main():
    ...
    results["engine_eager_row"] = _run_timed(_build_engine_row(args.rows, args.derived_fields), args.runs)
