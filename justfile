...
# 运行示例: 大数据的示例
examples-big-data:
    SCALIM_EXAMPLES_SUITES=demo_big_data_report PYTHONPATH="{{ justfile_directory() }}${PYTHONPATH:+:$PYTHONPATH}" uv {{ UV_OPTIONS }} run python scripts/run-marimo-notebooks.py
