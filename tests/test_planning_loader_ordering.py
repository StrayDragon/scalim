...
from scalim.planning.loader_ordering.sorting import sort_ref_loaders
...
def test_sort_ref_loaders_warns_and_falls_back_stably(caplog) -> None:
    ...
    warnings = [rec for rec in caplog.records if "Ref loader ordering degraded" in rec.message]
