...
sources:
  customers:
    loader: tests.params_template_loaders:load_customers_by_keys
    key: customer_id
    params:
      query:
...
""",
    ...
    _ = run(str(yaml_path), allowed_modules=frozenset(["tests.params_template_loaders"]), sink=sink)
...
sources:
  customers_rows:
    loader: tests.params_template_loaders:load_customers_by_rows
    key: customer_id
    params:
...
sources:
  refdata:
    loader: tests.params_template_loaders:load_preload_refdata
    key: config_id
