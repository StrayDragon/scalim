...
@pytest.mark.parametrize(
    ...
    [
        (excel_mod.ExcelSink, _FailingSaveWorkbook, "ExcelSink save failed", "exc_rows.xlsx", True),
        (excel_mod.ColumnExcelSink, _FailingSaveWorkbookNonWriteOnly, "ColumnExcelSink save failed", "exc_cols.xlsx", False),
    ],
    ids=["row-sink", "column-sink"],
)
