...
| --- | ---: | --- | --- |
| `scalim.dsl.yaml_dsl` | 43 | YAML DSL 官方运行入口 + 运行期契约 | 运行 demand/workflow YAML |
...
| `scalim.execution` | 10 | execution facade(run_ir + contracts) | DSL-agnostic 执行入口 + request/result 契约 |
