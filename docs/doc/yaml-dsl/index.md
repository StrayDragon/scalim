...
**YAML vs Python 边界速查**（0.10.*：无强制迁键；灰区含 `lookup_chunk_size` / `sources.*.cache_mode`）:

- 评审速记: [提案审核清单](review-checklist.md)（Authoring 边界 + 灰区）
- 键分类调研: `llmanspec/changes/c40-yaml-runtime-policy-boundary/inventory.md`
