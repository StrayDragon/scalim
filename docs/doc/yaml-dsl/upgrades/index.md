...
- [2026-09-08 — Python floor 3.10 + YAML 去 vendor + `scalim.vendor` 退役（0.20.0 统一发布）](repo:agentdev/skills/scalim-yaml-dsl/references/upgrades/2026-09-08-python-floor-310-and-vendor-retirement.md?ref)
